...
echo -e "\033[32m当前版本为:0.59\033[0m" 
echo 1.科学上网脚本集合
echo 2.各种工具脚本集合
echo 3.系统优化脚本集合
echo 4.计算圆周率
...
then
	...
	echo -e "\033[32m请手动执行:\033[0m"
        echo -e "\033[32mwget -N --no-check-certificate "https://raw.githubusercontent.com/mikulo/miku/master/miku.sh" && chmod +x miku.sh&& ./miku.sh\033[0m"
